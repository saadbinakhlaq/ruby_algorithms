...
The order within an individual path must start at the root and end at the leaf, but the relative order of among paths in the outer list does not matter.
